...
# Install new extensions using gext
...
# Enable the newly installed extensions
...
gsettings set org.gnome.shell.extensions.alphabetical-app-grid folder-order-position 'end'"Extensions installed! You may need to log out and back in for all changes to take effect."
