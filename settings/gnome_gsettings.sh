...
gsettings set org.gnome.shell favorite-apps "['org.gnome.Terminal.desktop', 'google-chrome.desktop', 'nemo.desktop', 'newsflash_newsflash.desktop', 'obsidian_obsidian.desktop', 'zotero-snap_zotero-snap.desktop', 'anki.desktop', 'org.gnome.gedit.desktop', 'org.gnome.Calculator.desktop', 'gimp_gimp.desktop', 'inkscape_inkscape.desktop', 'libreoffice-writer.desktop', 'libreoffice-calc.desktop', 'libreoffice-impress.desktop', 'rstudio.desktop', 'code_code.desktop', 'zoom-client_zoom-client.desktop', 'calibre-gui.desktop', 'gramps.desktop', 'kdenlive_kdenlive.desktop']"
