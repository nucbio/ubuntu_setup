...
gsettings set org.gnome.shell.extensions.dash-to-dock dash-max-icon-size 37
...
# Set the color scheme to dark (this is what the Settings UI uses)
...
# Night color temperature settings
